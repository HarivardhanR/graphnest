...
const YAxis = ({ numYAxisDivisions, yTickLabelAwayPadding }) => {
  console.log("Rendering:YAxis");

  const { maxValue, padding, adjustedHeight, height } =
    ...
    <g key={index}>
      <text
        ...
        y={
          height -
          padding.bottom -
          index * (adjustedHeight / numYAxisDivisions) +
          5
        }
        textAnchor="end"
        fill="black"
      ...
      <line
        x1={padding.left - 5}
        y1={
          height - padding.bottom - index * (adjustedHeight / numYAxisDivisions)
        }
        x2={padding.left}
        y2={
          height - padding.bottom - index * (adjustedHeight / numYAxisDivisions)
